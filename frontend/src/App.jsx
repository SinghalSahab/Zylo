...
import {CaptainLogin, CaptainSignup, Start, UserLogin, UserSignup , UserHome, UserProtectedWrapper, UserLogout,CaptainRiding, CaptainProtectedWrapper, CaptainHome, CaptainLogout, Riding} from './pages'
