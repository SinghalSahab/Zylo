    ...
    <div className=''>
        ...
        <form onSubmit={(e) =>{
          submitHandler(e);
            ...
            <h3 className='text-3xl mb-3'>Enter your password</h3>
            <input
            required 
            value = {password}
            onChange={(e)=>{
        ...
        <div>
         Want join a fleet? <Link to='/captains/register' className='text-blue-600  font-medium'>Register as a captain</Link>
        </div>
        </div>
        <div>
        <Link
