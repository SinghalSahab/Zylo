...
const UserHome = () => {
     ...
     const [WaitForDriver,setWaitingForDriver] = useState(false);
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      ...
      <div className='flex flex-col justify-end h-screen absolute w-full top-0'>
        ...
        <button className='bg-black text-white w-full py-2 px-2 mt-6 rounded-lg mb-2 font-semibold'>
          Find Trip
        </button>
        </div>
